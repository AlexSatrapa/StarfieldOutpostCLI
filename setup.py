...
setup(
    name='OutpostCLI',
    description="Produce a bill of materials for an outpost construction",
    ...
    entry_points = {
		'console_scripts': [
			'outpost=outpostcli.cli:outpost',
		]
    },
    python_requires=">=0.0.1",
    license='GPLv3',  # noqa
    author='Alex Satrapa',
    author_email='grail@goldweb.com.au',
    # Use the URL to the github repo.
    url= 'https://github.com/AlexSatrapa/outpostcli',
    download_url=(
        f'https://github.com/AlexSatrapa/'
        f'outpostcli/archive/{version}.tar.gz'
    ),
    keywords=[
